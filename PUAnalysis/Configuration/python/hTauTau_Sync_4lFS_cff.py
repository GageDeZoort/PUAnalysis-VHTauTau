...
MMTM = CutSequenceProducer(initialCounter = 'initialEventsTT', pyModuleName = __name__,
                           pyNameSpace = locals())

MMTM.addDiCandidateModule('diMuons', 'PATDiMuonPairProducer', 'slimmedMuons', 'slimmedMuons', 'slimmedMETs', '', 'slimmedJets')
