...
class CutSequenceProducer(cms._ParameterTypeBase):
    ...
    def addDiCandidateModule(self,moduleName,moduleType, src1,src2,met,taus,jets,min = 1,
                             max=9999,text = '',leadingObjectsOnly = False,dR = 0.3,
                             recoMode = "",genParticles = 'genTaus'):
