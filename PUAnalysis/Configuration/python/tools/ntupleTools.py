...
#MODIFIED
def makeQuadLeptonFS(sourceQuadLeptonFS, FSLeptonString, tagName, methodName, leadingOnly=True):
   PSet = cms.PSet(
         pluginType  = cms.string("PAT" + FSLeptonString + "QuadFiller"),
         src         = cms.InputTag(sourceQuadLeptonFS),
         tag         = cms.string(tagName),
         method      = cms.string(methodName),
         leadingOnly = cms.untracked.bool(leadingOnly)
   )
...
def addDiTauEventTree(process,name,src = 'diTausOS', srcLL = 'diMuonsOSSorted', srcU='TightMuons', srcE='TightElectrons',triggerCollection='HLT', fileNameString = "output.root", isEmbedded=False, isJHU=False):
   process.TFileService = cms.Service("TFileService", fileName = cms.string(fileNameString) )
   eventTree = cms.EDAnalyzer('EventTreeMaker',
			           ...
			           prescales = cms.InputTag("patTrigger"),
                              ...
                              #MODIFIED
                              quadLeptonTESTVARmmmm = makeQuadLeptonFS(src,"MuMuMuMu","TESTVARmmmm", "pt"),
                              quadLeptonTESTVARmmem = makeQuadLeptonFS(src,"MuMuEleMu","TESTVARmmem", "pt"),
                              quadLeptonTESTVARmmee = makeQuadLeptonFS(src,"MuMuEleEle","TESTVARmmee", "pt"),
                              quadLeptonTESTVARmmet = makeQuadLeptonFS(src,"MuMuEleTau","TESTVARmmet", "pt"),
                              quadLeptonTESTVARmmtt = makeQuadLeptonFS(src,"MuMuTauTau","TESTVARmmtt", "pt"),
                              quadLeptonTESTVARmmmt = makeQuadLeptonFS(src,"MuMuMuTau","TESTVARmmmt", "leg2.leg2.pt"),
                              quadLeptonHiggsMass = makeQuadLeptonFS(src,"MuMuMuTau","HiggsMass","leg2.mass()"),
                              quadLeptonTESTVARZMass = makeQuadLeptonFS(src,"MuMuMuTau","ZMass","leg1.mass()"),
                              quadLeptonTESTVAReemm = makeQuadLeptonFS(src,"EleEleMuMu","TESTVAReemm", "pt"),
                              quadLeptonTESTVAReeem = makeQuadLeptonFS(src,"EleEleEleMu","TESTVAReeem", "pt"),
                              quadLeptonTESTVAReeee = makeQuadLeptonFS(src,"EleEleEleEle","TESTVAReeee", "pt"),
                              quadLeptonTESTVAReeet = makeQuadLeptonFS(src,"EleEleEleTau","TESTVAReeet", "pt"),
                              quadLeptonTESTVAReett = makeQuadLeptonFS(src,"EleEleTauTau","TESTVAReett", "pt"),
                              quadLeptonTESTVAReemt = makeQuadLeptonFS(src,"EleEleMuTau","TESTVAReemt", "pt"),
...
###Embedded option
                              ...
                              diTauDeepBJet1PtPtSort = makeDiTauPtPair(src,"bpt_1",'abs(eta())<2.5&&pt()>20&&bDiscriminator("pfDeepCSVDiscriminatorsJetTags:BvsAll")>0.4941','pt()',0),
                              diTauDeepBJet2PtPtSort = makeDiTauPtPair(src,"bpt_2",'abs(eta())<2.5&&pt()>20&&bDiscriminator("pfDeepCSVDiscriminatorsJetTags:BvsAll")>0.4941','pt()',1),
                              ...
                              diTauDeepBJet1EtaPtSort = makeDiTauPtPair(src,"beta_1",'abs(eta())<2.5&&pt>20&&bDiscriminator("pfDeepCSVDiscriminatorsJetTags:BvsAll")>0.4941','eta()',0),
                              diTauDeepBJet2EtaPtSort = makeDiTauPtPair(src,"beta_2",'abs(eta())<2.5&&pt>20&&bDiscriminator("pfDeepCSVDiscriminatorsJetTags:BvsAll")>0.4941','eta()',1),
                              diTauDeepBJet1PhiPtSort = makeDiTauPtPair(src,"bphi_1",'abs(eta())<2.5&&pt>20&&bDiscriminator("pfDeepCSVDiscriminatorsJetTags:BvsAll")>0.4941','phi()',0),
                              diTauDeepBJet2PhiPtSort = makeDiTauPtPair(src,"bphi_2",'abs(eta())<2.5&&pt>20&&bDiscriminator("pfDeepCSVDiscriminatorsJetTags:BvsAll")>0.4941','phi()',1),
                              diTauDeepBJet1CSVPtSort = makeDiTauPtPair(src,"bcsv_1",'abs(eta())<2.5&&pt()>20&&bDiscriminator("pfDeepCSVDiscriminatorsJetTags:BvsAll")>0.4941','bDiscriminator("pfDeepCSVDiscriminatorsJetTags:BvsAll")',0),
                              diTauDeepBJet2CSVPtSort = makeDiTauPtPair(src,"bcsv_2",'abs(eta())<2.5&&pt()>20&&bDiscriminator("pfDeepCSVDiscriminatorsJetTags:BvsAll")>0.4941','bDiscriminator("pfDeepCSVDiscriminatorsJetTags:BvsAll")',1),
