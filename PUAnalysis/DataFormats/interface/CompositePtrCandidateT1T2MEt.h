...
// This is "template specialization", which primes the function
//   to work with 2 arbitrary types T1 and T2 
template<typename T1, typename T2>
class CompositePtrCandidateT1T2MEt : public reco::LeafCandidate {
  
  // Variables belonging to the class -> pointers to relevant
  //   physics objects (T1, T2, Met, JetVector)
 ...
 public:
  ...
  /// access to gen. mother particles (undecayed tau leptons)
  ...
  /// (the candidates used to construct this Candidate, MET does not count)
  ...
  ////get rid of these
  double J1MatchedBpt() const {return J1MatchedB_.pt();}
...
//MODIFIED
//Lump together sets of two physics objects -> PAT*Pair
...
//MODIFIED
//Lump together sets of two PAT*Pairs -> PATfsQuad (fs = final sate)
