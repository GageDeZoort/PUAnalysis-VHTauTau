...
namespace {
  ...
  struct UWanalysis_DataFormats_dictionary {
    ...
    //MODIFIED, 4l FS PATfsQuad Object Creation: 
    ...
    edm::Wrapper<PATMuMuMuMuQuad> dummyPATMuMuMuMuQuadWrapper;
    ...
    edm::Wrapper<PATEleEleEleTauQuad> dummyPATEleEleEleTauQuadWrapper;
