...
scram b
mkdir data
#git clone -b 2017 https://git@gitlab.cern.ch:/cms-htt/Jet2TauFakesFiles.git data
git clone -b 2017 https://gitlab.cern.ch:/cms-htt/Jet2TauFakesFiles.git data --depth 1
cd data
git fetch --unshallow
cd $CMSSW_BASE/src
