/*
 * DiCandidatePairProducer.cc
 * Updated June 28th, 2019
 * By Gage DeZoort
 *
 */

#include "PUAnalysis/RecoTools/interface/CompositePtrCandidateT1T2MEtProducer.h"
#include "PUAnalysis/RecoTools/plugins/DiCandidatePairProducer.h" 
